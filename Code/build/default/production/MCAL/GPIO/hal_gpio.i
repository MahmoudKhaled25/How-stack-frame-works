...
# 12 "MCAL/GPIO/../device_config.h" 2
...
Std_ReturnType gpio_pin_direction_initialize (const pin_config_t *_pin_config)
{
    ...
    if (((void*)0) == _pin_config || _pin_config->port_index > PORTE_INDEX || _pin_config->pin_index > PIN7)
    {
        ret_State = E_NOT_OK;
    }
    else
    {
        ...
        {
            case GPIO_OUTPUT :
                ((*tris_regs[_pin_config->port_index]) &= ~(0x01 << (_pin_config->pin_index)));
                break;
...
Std_ReturnType gpio_pin_get_direction (const pin_config_t *_pin_config, pin_direction_t *direction_status)
{
    ...
    if (((void*)0) == _pin_config || ((void*)0) == direction_status || _pin_config->port_index > PORTE_INDEX || _pin_config->pin_index > PIN7)
    {
        ret_State = E_NOT_OK;
    }
    else
...
Std_ReturnType gpio_pin_write_logic (pin_config_t *_pin_config, pin_logic_t logic)
{
    ...
    else
    {
        ...
        {
            case GPIO_LOW:
                ((*lat_regs[_pin_config->port_index]) &= ~(0x01 << (_pin_config->pin_index)));
                break;
        ...
        _pin_config->logic = (((*port_regs[_pin_config->port_index]) >> (_pin_config->pin_index)) & 0x01);
    }
...
Std_ReturnType gpio_pin_read_logic (const pin_config_t *_pin_config, pin_logic_t *logic)
{
    ...
    if (((void*)0) == _pin_config || ((void*)0) == logic || _pin_config->port_index > PORTE_INDEX || _pin_config->pin_index > PIN7)
    {
        ret_State = E_NOT_OK;
    }
    else
    {
        *logic = (((*port_regs[_pin_config->port_index]) >> (_pin_config->pin_index)) & 0x01);
    }
...
Std_ReturnType gpio_pin_toggle_logic (pin_config_t *_pin_config)
{
    ...
    if (((void*)0) == _pin_config || _pin_config->port_index > PORTE_INDEX || _pin_config->pin_index > PIN7 || GPIO_INPUT == _pin_config->pin_direction)
    {
        ret_State = E_NOT_OK;
    }
    else
...
Std_ReturnType gpio_port_get_direction (port_index_t port, uint8 *direction_status)
{
    ...
    if (((void*)0) == direction_status || port > PORTE_INDEX)
    {
        ret_State = E_NOT_OK;
    }
    else
...
Std_ReturnType gpio_port_read_logic (port_index_t port, uint8 *logic)
{
    ...
    if (((void*)0) == logic || port > PORTE_INDEX)
    {
        ret_State = E_NOT_OK;
    }
    else
