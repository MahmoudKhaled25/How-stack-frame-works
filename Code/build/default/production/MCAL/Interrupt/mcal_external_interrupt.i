...
# 13 "MCAL/Interrupt/../mcal_std_types.h"
...
# 14 "MCAL/Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL/Interrupt/../GPIO/hal_gpio_cfg.h" 1
# 14 "MCAL/Interrupt/../GPIO/hal_gpio.h" 2
...
# 151 "MCAL/Interrupt/mcal_external_interrupt.h"
...
# 169 "MCAL/Interrupt/mcal_external_interrupt.h"
...
static Std_ReturnType Interrupt_INTx_Enable(const inetrrupt_INTx_t *int_obj)
{
    ...
    if (int_obj)
    {
        ...
        {
            case INTERRUPT_EXTERNAL_INT0 : (INTCONbits.INT0E = 1); break;
            case INTERRUPT_EXTERNAL_INT1 : (INTCON3bits.INT1E = 1); break;
            case INTERRUPT_EXTERNAL_INT2 : (INTCON3bits.INT2E = 1); break;
...
static Std_ReturnType Interrupt_INTx_Disable(const inetrrupt_INTx_t *int_obj)
{
    ...
    if (int_obj)
    {
        ...
        switch (int_obj->source)
        {
            ...
            case INTERRUPT_EXTERNAL_INT1 : (INTCON3bits.INT1E = 0); break;
            case INTERRUPT_EXTERNAL_INT2 : (INTCON3bits.INT2E = 0); break;
            default : ret = E_NOT_OK;
        }
    } else { }
