...
# 12 "ECUAL/Chr_LCD/ecu_chr_lcd.h"
# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h" 1
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h"
# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/../device_config.h" 1
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../device_config.h"
# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/../compiler.h" 1
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../compiler.h"
...
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../compiler.h" 2
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../device_config.h" 2
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/../mcal_std_types.h" 1
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../mcal_std_types.h"
# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/../std_libraries.h" 1
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../std_libraries.h"
...
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../std_libraries.h" 2
...
# 14 "ECUAL/Chr_LCD/../../MCAL/GPIO/../std_libraries.h" 2
# 12 "ECUAL/Chr_LCD/../../MCAL/GPIO/../mcal_std_types.h" 2
...
# 13 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 14 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h" 2
# 41 "ECUAL/Chr_LCD/../../MCAL/GPIO/hal_gpio.h"
typedef enum
{
    PORTA_INDEX,
    PORTB_INDEX,
...
static pin_config_t data_pins[4];
...
Std_ReturnType lcd_init(const chr_lcd_t *lcd)
{
    ...
    if(lcd)
    {
        ...
        ret &= lcd_send_command(lcd, 0x20 >> 4);
        ret &= lcd_send_command(lcd, 0x20 | 0x28);
...
Std_ReturnType lcd_send_data_pos(const chr_lcd_t *lcd, uint8 row, uint8 column, uint8 data)
{
    ...
    if(lcd)
    {
        ...
        {
            case 1:
                ret &= lcd_send_command(lcd, (0x80 + 0x00) + column);
                break;
            case 2:
                ret &= lcd_send_command(lcd, (0x80 + 0x40) + column);
                break;
            case 3:
                ret &= lcd_send_command(lcd, (0x80 + 0x14) + column);
                break;
            case 4:
                ret &= lcd_send_command(lcd, (0x80 + 0x54) + column);
                break;
        }
