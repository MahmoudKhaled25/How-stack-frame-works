...
# 13 "./ECUAL/ecu_layer_init.h"
# 1 "./ECUAL/LED/ecu_led.h" 1
# 12 "./ECUAL/LED/ecu_led.h"
# 1 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h" 1
# 12 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h"
# 1 "./ECUAL/LED/../../MCAL/GPIO/../device_config.h" 1
# 12 "./ECUAL/LED/../../MCAL/GPIO/../device_config.h"
...
# 12 "./ECUAL/LED/../../MCAL/GPIO/../device_config.h" 2
# 12 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h" 2
...
# 13 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 14 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h" 2
# 41 "./ECUAL/LED/../../MCAL/GPIO/hal_gpio.h"
typedef enum
{
    PORTA_INDEX,
    PORTB_INDEX,
...
# 51 "./ECUAL/Button/ecu_button.h"
Std_ReturnType button_init(const button_t *const button);
# 62 "./ECUAL/Button/ecu_button.h"
...
# 12 "./ECUAL/Relay/ecu_relay.h"
# 1 "./ECUAL/Relay/ecu_relay_cfg.h" 1
# 12 "./ECUAL/Relay/ecu_relay.h" 2
# 25 "./ECUAL/Relay/ecu_relay.h"
...
# 74 "./ECUAL/DC_Motor/ecu_dc_motor.h"
Std_ReturnType dc_motor_init(const dc_motor_t *const dc_motor);
# 86 "./ECUAL/DC_Motor/ecu_dc_motor.h"
Std_ReturnType dc_motor_move_right(dc_motor_t *const dc_motor);
# 98 "./ECUAL/DC_Motor/ecu_dc_motor.h"
Std_ReturnType dc_motor_move_left(dc_motor_t *const dc_motor);
# 110 "./ECUAL/DC_Motor/ecu_dc_motor.h"
Std_ReturnType dc_motor_stop(dc_motor_t *const dc_motor);
# 16 "./ECUAL/ecu_layer_init.h" 2

# 1 "./ECUAL/Seven_Segment/ecu_seven_seg.h" 1
# 12 "./ECUAL/Seven_Segment/ecu_seven_seg.h"
# 1 "./ECUAL/Seven_Segment/ecu_seven_seg_cfg.h" 1
# 12 "./ECUAL/Seven_Segment/ecu_seven_seg.h" 2
# 25 "./ECUAL/Seven_Segment/ecu_seven_seg.h"
typedef enum
{
    SEGMENT_PIN_OFF,
    SEGMENT_PIN_ON
...
typedef struct
{
    uint8 segment_port : 3;
    uint8 segment_pin : 3;
    uint8 segment_pin_status : 1;
    uint8 reserved : 1;
} segment_pin_t;
...
typedef struct
{
    keypad_pin_t keypad_row_pins[4];
    keypad_pin_t keypad_column_pins[4];
    keypad_type_t keypad_type;
}keypad_t;
# 78 "./ECUAL/Keypad/ecu_keypad.h"
...
# 18 "./ECUAL/ecu_layer_init.h" 2

# 1 "./ECUAL/Chr_LCD/ecu_chr_lcd.h" 1
# 13 "./ECUAL/Chr_LCD/ecu_chr_lcd.h"
# 1 "./ECUAL/Chr_LCD/ecu_chr_lcd_cfg.h" 1
# 13 "./ECUAL/Chr_LCD/ecu_chr_lcd.h" 2
# 45 "./ECUAL/Chr_LCD/ecu_chr_lcd.h"
